...
const getAll = () => {
  const request = __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(baseUrl);
  return request.then(response => response.data);
};

const createBlogPost = (() => {
  var _ref = _asyncToGenerator(function* (blogPost) {
    ...
    const response = yield __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(baseUrl, blogPost, config);
    return response.data;
  });

  return function createBlogPost(_x) {
    return _ref.apply(this, arguments);
  };
})();

const updateBlogPost = (() => {
  var _ref2 = _asyncToGenerator(function* (blogPost) {
    ...
    const response = yield __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put(`${baseUrl}/${blogPost.id}`, blogPost, config);
    return response.data;
  });

  return function updateBlogPost(_x2) {
...
const removeBlogPost = (() => {
  var _ref3 = _asyncToGenerator(function* (id) {
    ...
    const response = yield __WEBPACK_IMPORTED_MODULE_0_axios___default.a.delete(`${baseUrl}/${id}`, config);
    return response.data;
  });

  return function removeBlogPost(_x3) {
    return _ref3.apply(this, arguments);
  };
})();

const addCommentToPost = (() => {
  var _ref4 = _asyncToGenerator(function* (id, comment) {
    console.log('comment: ', comment);
    const response = yield __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(`${baseUrl}/${id}/comments`, comment);
    console.log('response: ', response);
    return response.data;
  });

  return function addCommentToPost(_x4, _x5) {
...
const getComments = (() => {
  var _ref5 = _asyncToGenerator(function* (id) {
    const response = yield __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(`${baseUrl}/${id}/comments`);
    return response.data;
  });

  return function getComments(_x6) {
    return _ref5.apply(this, arguments);
  };
})();

/* harmony default export */ __webpack_exports__["a"] = ({ getAll, setToken, createBlogPost, updateBlogPost, removeBlogPost, addCommentToPost, getComments });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_invariant__ = __webpack_require__(124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_react_router_dom__ = __webpack_require__(116);
...
const render = () => {
  __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      null,
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__App__["default"], null)
    )
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(1);var invariant=__webpack_require__(9);var warning=__webpack_require__(12);var ExecutionEnvironment=__webpack_require__(25);var _assign=__webpack_require__(8);var emptyFunction=__webpack_require__(4);var EventListener=__webpack_require__(26);var getActiveElement=__webpack_require__(27);var shallowEqual=__webpack_require__(28);var containsNode=__webpack_require__(29);var focusNode=__webpack_require__(30);var emptyObject=__webpack_require__(11);var checkPropTypes=__webpack_require__(15);var hyphenateStyleName=__webpack_require__(59);var camelizeStyleName=__webpack_require__(61);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
throw new Error("Module build failed: SyntaxError: Unexpected token (50:24)\n\n\u001b[0m \u001b[90m 48 | \u001b[39m  }\n \u001b[90m 49 | \u001b[39m\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 50 | \u001b[39m  toggleLoginVisibility \u001b[33m=\u001b[39m () \u001b[33m=>\u001b[39m {\n \u001b[90m    | \u001b[39m                        \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 51 | \u001b[39m    \u001b[36mthis\u001b[39m\u001b[33m.\u001b[39msetState({ loginVisible\u001b[33m:\u001b[39m \u001b[33m!\u001b[39m\u001b[36mthis\u001b[39m\u001b[33m.\u001b[39mstate\u001b[33m.\u001b[39mloginVisible })\n \u001b[90m 52 | \u001b[39m  }\n \u001b[90m 53 | \u001b[39m\u001b[0m\n");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_reducers_notificationReducer__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_redux_thunk__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__reducers_userReducer__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__reducers_blogReducer__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__reducers_loggedInUserReducer__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__reducers_loginInfoReducer__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__reducers_newCommentReducer__ = __webpack_require__(94);
...
const reducer = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["c" /* combineReducers */])({
  notification: __WEBPACK_IMPORTED_MODULE_1__src_reducers_notificationReducer__["a" /* default */],
  users: __WEBPACK_IMPORTED_MODULE_3__reducers_userReducer__["a" /* default */],
  blogs: __WEBPACK_IMPORTED_MODULE_4__reducers_blogReducer__["a" /* default */],
  user: __WEBPACK_IMPORTED_MODULE_5__reducers_loggedInUserReducer__["a" /* default */],
  loginInfo: __WEBPACK_IMPORTED_MODULE_6__reducers_loginInfoReducer__["a" /* default */],
  newComment: __WEBPACK_IMPORTED_MODULE_7__reducers_newCommentReducer__["a" /* default */]
});

const store = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["d" /* createStore */])(reducer, Object(__WEBPACK_IMPORTED_MODULE_0_redux__["a" /* applyMiddleware */])(__WEBPACK_IMPORTED_MODULE_2_redux_thunk__["a" /* default */]));
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(32), __webpack_require__(66)(module)))
...
const notify = (message, timeInSeconds) => {
  return (() => {
...
/* harmony default export */ __webpack_exports__["a"] = (notificationReducer);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_users__ = __webpack_require__(71);
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }
...
const initializeUsers = () => {
  return (() => {
    var _ref = _asyncToGenerator(function* (dispatch) {
      const users = yield __WEBPACK_IMPORTED_MODULE_0__services_users__["a" /* default */].getAllUsers();
      dispatch({
        type: 'INIT_USERS',
        users
      });
...
/* unused harmony export initializeUsers */
...
const getAllUsers = (() => {
  var _ref = _asyncToGenerator(function* () {
    const res = yield __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(baseUrl);
    return res.data;
  });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_blogs__ = __webpack_require__(38);
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }
...
const initializeBlogs = () => {
  return (() => {
    var _ref = _asyncToGenerator(function* (dispatch) {
      const blogs = yield __WEBPACK_IMPORTED_MODULE_0__services_blogs__["a" /* default */].getAll();
      dispatch({
        type: 'INIT_BLOGS',
        blogs
      });
...
/* unused harmony export initializeBlogs */
...
/* unused harmony export createNewBlog */
...
/* unused harmony export updateBlog */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_login__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_blogs__ = __webpack_require__(38);
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }
...
const login = userTryingToLogin => {
  return (() => {
    var _ref = _asyncToGenerator(function* (dispatch) {

      const user = yield __WEBPACK_IMPORTED_MODULE_0__services_login__["a" /* default */].login(userTryingToLogin);
      __WEBPACK_IMPORTED_MODULE_1__services_blogs__["a" /* default */].setToken(user.token);

      yield window.localStorage.setItem('loggedUser', JSON.stringify(user));
...
const continueSession = existingUser => {
  return (() => {
    var _ref2 = _asyncToGenerator(function* (dispatch) {
      dispatch({
        type: 'CONT',
...
/* unused harmony export continueSession */
...
/* harmony default export */ __webpack_exports__["a"] = (loggedInUserReducer);
...
const login = (() => {
  var _ref = _asyncToGenerator(function* (creds) {
    const response = yield __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(baseUrl, creds);
    return response.data;
  });
...
const updateLoginInfo = userInfoObj => {
  return dispatch => {
    dispatch({
      type: 'UPDATE_LINFO',
      data: userInfoObj
...
/* unused harmony export updateLoginInfo */
...
/* unused harmony export resetLoginInfo */


/* harmony default export */ __webpack_exports__["a"] = (loginInfoReducer);
...
/* unused harmony export resetComment */
...
/* unused harmony export updateComment */


/* harmony default export */ __webpack_exports__["a"] = (newCommentReducer);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__generatePath__ = __webpack_require__(137);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__generatePath__ = __webpack_require__(50);
var _extends = Object.assign || function (target) {
  for (var i = 1; i < arguments.length; i++) {
    var source = arguments[i];for (var key in source) {
      if (Object.prototype.hasOwnProperty.call(source, key)) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_generatePath__ = __webpack_require__(50);
// Written in this round about way for babel-transform-imports
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_withRouter__ = __webpack_require__(140);
// Written in this round about way for babel-transform-imports
